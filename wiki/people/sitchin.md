...
**Захария Ситчин** (1920–2010) — писатель и исследователь шумерских текстов.

## Примечание

Валидация выявила дублирование: `sitchin` и `zacharia-sitchin`. Основная статья: [[people/erih-fon-daniken|Захария Ситчин]].
